...
class RegistroViewModel : ViewModel() {
    ...
    fun onPasswordChanged(newPass: String) { password.value = newPass }
    fun onConfirmChanged(newConfirm: String) { confirm.value = newConfirm }
    ...
    fun registrarUsuario(onSuccess: () -> Unit) {
        ...
        viewModelScope.launch {
            ...
            val result = authRepository.registrarUsuarioFirebase(usuario)
